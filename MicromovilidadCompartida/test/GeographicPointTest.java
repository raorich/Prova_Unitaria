...
class GeographicPointTest {
    ...
    void testEqualsMethod_SameObject() {
        assertTrue(validPoint1.equals(validPoint1)); // Reflexividad
    }
    ...
    void testEqualsMethod_DifferentLatitude() {
        assertFalse(validPoint1.equals(validPointDifferentLatitude)); // Diferentes latitudes
    }

    @Test
    void testEqualsMethod_DifferentLongitude() {
        assertFalse(validPoint1.equals(validPointDifferentLongitude)); // Diferentes longitudes
    }

    @Test
    void testEqualsMethod_EqualObjects() {
        assertTrue(validPoint1.equals(validPoint2)); // Mismas coordenadas
    }
}
